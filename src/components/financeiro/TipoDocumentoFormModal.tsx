...
interface TipoDocumentoFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: TipoDocumentoFinanceiroItem) => Promise<void>;
  data?: TipoDocumentoFinanceiroItem | null;
  readOnly?: boolean;
...
export const TipoDocumentoFormModal = ({
  isOpen,
  onClose,
  onSave,
  data,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[900px] max-w-[900px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{data ? 'Editar Tipo de Documento' : 'Novo Tipo de Documento'}</DialogTitle>
          <DialogDescription>
            Preencha os campos abaixo para {data ? 'editar' : 'cadastrar'} o tipo de documento.
          </DialogDescription>
        </DialogHeader>
...
export default TipoDocumentoFormModal;
