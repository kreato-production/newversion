...
export const formsRegistry: FormDefinition[] = [
  ...
  },
  {
    ...
    campos: [
      ...
      { campo: 'centroLucro', label: 'Centro de Custos' },
  ...
  {
    id: 'incidenciaGravacao',
    nome: 'Incidência de Gravação',
    modulo: 'Produção',
    campos: [
      { campo: 'codigoExterno', label: 'Código Externo' },
      { campo: 'titulo', label: 'Título' },
      { campo: 'gravacaoId', label: 'Gravação' },
      { campo: 'recursoFisicoId', label: 'Recurso Físico' },
      { campo: 'severidadeId', label: 'Severidade' },
      { campo: 'impactoId', label: 'Impacto' },
      { campo: 'categoriaId', label: 'Categoria' },
      { campo: 'classificacaoId', label: 'Classificação' },
      { campo: 'dataIncidencia', label: 'Data da Incidência' },
      { campo: 'horarioIncidencia', label: 'Horário da Incidência' },
      { campo: 'tempoIncidencia', label: 'Tempo da Incidência' },
      { campo: 'descricao', label: 'Descrição' },
      { campo: 'causaProvavel', label: 'Causa Provável' },
    ],
  },
  {
    id: 'centroLucro',
    ...
    campos: [
      { campo: 'codigoExterno', label: 'Código Externo' },
      { campo: 'nome', label: 'Nome' },
      { campo: 'parentId', label: 'Centro de Custos Pai' },
      { campo: 'status', label: 'Status' },
      { campo: 'descricao', label: 'Descrição' },
    ],
  },
