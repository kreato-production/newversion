...
const generatePermissionId = (
  ...
  return `${modulo}_${subModulo1}_${subModulo2}_${campo}`
...
export const basePermissionsMatrix: Omit<PermissionItem, 'id'>[] = [
  ...
  },
  {
    ...
    subModulo1: 'Conteúdo',
    subModulo2: '-',
    campo: 'Tabulador "Recursos Técnicos"',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
    alterar: true,
  ...
  },
  {
    ...
    subModulo1: 'Conteúdo',
    subModulo2: '-',
    campo: 'Tabulador "Recursos Físicos"',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
    alterar: true,
  ...
  },
  {
    modulo: 'Produção',
    subModulo1: 'Mapas',
    subModulo2: 'Vista "Recursos Físicos"',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
  ...
  },
  {
    modulo: 'Produção',
    subModulo1: 'Mapas',
    subModulo2: 'Vista "Recursos Humanos"',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
  ...
  // Produção > Grelha de Programação
  {
    modulo: 'Produção',
    subModulo1: 'Grelha de Programação',
    subModulo2: '-',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
  ...
  },
  {
    ...
    subModulo1: 'Parametrizações',
    subModulo2: 'Categorias de Incidência',
    campo: 'Tabulador "Classificações"',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
    alterar: true,
  ...
  {
    modulo: 'Produção',
    subModulo1: 'Incidências de Gravação',
    subModulo2: '-',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
  ...
  {
    modulo: 'Administração',
    subModulo1: 'Unidades de Negócio',
    subModulo2: '-',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
  ...
  },
  {
    ...
    subModulo1: 'Centros de Custos',
    subModulo2: '-',
    campo: 'Centro de Custos Superior',
    acao: 'visible',
    somenteLeitura: false,
    incluir: true,
    alterar: true,
  ...
  // Gestão de Eventos > Expositores
  {
    modulo: 'Gestão de Eventos',
    subModulo1: 'Expositores',
    subModulo2: '-',
    campo: '-',
    acao: 'visible',
    somenteLeitura: false,
  ...
  // Gestão de Eventos > Parametrizações > Tipo de Evento
  {
    modulo: 'Gestão de Eventos',
    subModulo1: 'Parametrizações',
  ...
  // Gestão de Eventos > Parametrizações > Tipo de Expositor
  {
    modulo: 'Gestão de Eventos',
    subModulo1: 'Parametrizações',
...
export const clonePermissionsAsync = async (
  ...
  const sourceData = await apiRepository.getPerfilPermissions(sourcePerfilId);

  if (!sourceData || sourceData.permissoes.length === 0) return null;

  const clonedPermissions: PermissionItem[] = sourceData.permissoes.map((p) => ({
    id: generatePermissionId(p.modulo, p.subModulo1 || '-', p.subModulo2 || '-', p.campo || '-'),
    modulo: p.modulo,
    subModulo1: p.subModulo1 || '-',
    subModulo2: p.subModulo2 || '-',
    campo: p.campo || '-',
    acao: p.acao,
    somenteLeitura: p.somenteLeitura || false,
...
export const savePerfilPermissionsAsync = async (
  ...
  apiRepository.savePerfilPermissions(perfilPermissoes.perfilId, perfilPermissoes.permissoes);
...
export const getPerfilPermissionsAsync = async (
  ...
  const response = await apiRepository.getPerfilPermissions(perfilId);
  if (!response || response.permissoes.length === 0) return null;
  return response;
};
