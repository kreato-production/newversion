...
export async function buildApp(options: BuildAppOptions = {}) {
  ...
  const eventosService = options.eventosService ?? new EventosService(new PrismaEventosRepository(), contasPagarRepository);
  ...
  const gravacoesService = options.gravacoesService ?? new GravacoesService(new PrismaGravacoesRepository(), contasPagarRepository, grelhaRepository);
